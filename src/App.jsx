...
import basicMaze from "./components/algorithm/maze/basic-maze";
import recursiveDivision from "./components/algorithm/maze/recursive_division";
import Randomized_dfs from "./components/algorithm/maze/randomized_dfs";
import BFS from "./components/algorithm/path/bfs";
import DFS from "./components/algorithm/path/dfs";
...
const App = () => {
  ...
  return (
    <Layout>
      <div>
        <h2 className="text-center capitalize text-slate-300 p-2  font-bold text-2xl">
          ...
          <div className="path-header">
            <div>
              <div style={{ display: "flex", margin: "6px auto" }}>
                <div>
                  <button className="bg-purple box-border cursor-pointer py-1 px-3 me-2 text-white rounded-md font-medium leading-5 whitespace-nowrap touch-manipulation relative" onClick={pathFinding}>
                    Find the possible path
                  </button>
                </div>
                <div>
                  <select
                    className="my-drop-down rounded-md text-purple"
                    value={pathID}
                    onChange={(e) => {
